            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarsExampleDefault">
                    <ul class="navbar-nav m-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="HomeController_1?action=logout">Logout</a>
                        </li>
                    </ul>
                        ...
                        <c:forEach items="${listRooms}" var="o">
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <h4 class="card-title show_txt"><a href="#" title="View Product">${o.roomNumber}</a></h4>
                                        <p class="card-text show_txt">${o.roomType}</p>
                                        <div class="row">
                                            <div class="col">
                                            ...
                                            <div class="col" >
	                                            <c:if test="${!o.isbooked}">
						                            <form action="BookingController" method="get">
						                                <input type="hidden" name="roomNumber" value="${o.roomNumber}">
						                                <input type="submit" class="btn btn-success btn-block" value="Book Now">
						                            </form>
						                        </c:if>
                                                <!-- <a href="BookingController?action=" class="btn btn-success btn-block">Add to cart</a> -->
                                            </div>
                                        </div>
                                    </div>
                                </div>
